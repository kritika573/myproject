...
$ids= $_POST['id'];
$strSQL = "SELECT t1.id AS newcol , t2.owner_name AS newcola , t1.dues AS newcolb, t2.members AS newcolc, t2.doj AS newcold FROM ownerbilldetails AS t1 JOIN adduser AS T2 ON t1.id = t2.id 
WHERE t2.id='$ids'";
